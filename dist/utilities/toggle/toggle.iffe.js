var Toggle = (function () {
  ...
  Toggle.prototype.getTarget = function getTarget(element) {
    ...
    target = element.hasAttribute('aria-controls') ? document.querySelector("#" + element.getAttribute('aria-controls')) : target;
    return target;
  };
  /**
  ...
  Toggle.prototype.toggle = function toggle(event) {
    ...
    if (element.dataset[this.settings.namespace + "Undo"]) {
      var undo = document.querySelector(element.dataset[this.settings.namespace + "Undo"]);
  ...
  Toggle.prototype.toggleFocusable = function toggleFocusable(elements) {
    elements.forEach(function (element) {
      ...
      if (tabindex === '-1') {
        var dataDefault = element.getAttribute("data-" + Toggle.namespace + "-tabindex");
