...
/**
 * Creates a directory and files within it based on the passed configuration.
 * It Will used a template file in the scaffold directory as the contents for
 * the individual files.
 *
 * @param {String} base  Basepath for the passed directory
 * @param {Object} dir   Directory object to create
 */
...
/**
 * Walks a JSON object directory tree configuration.
 *
 * @param {String} base  Basepath for the passed directory
 * @param {Object} dir   Directory object to create
 */
